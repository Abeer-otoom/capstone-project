                ...
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo $customSet['name']; ?>"  required />
                        </div>
                        
                        <div class="form-group">
                            <input type="text" class="form-input" name="email" placeholder="Your Email" 
                                    value="<?php echo $customSet['email']; ?>" required />
                             <div style="color:red; ">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input"  placeholder="Your Address" name="address" required value="<?php echo $customSet['address']; ?>" />
                           
                        </div>
                         <div class="form-group">
                            <input type="text" class="form-input"  placeholder="Your Phone-Number" name="phone" required value="<?php echo $customSet['phone']; ?>" />
                             <div style="color:red; ">
                         ...
                         <div class="form-group">
                            <input type="password" class="form-input" name="password" id="password" placeholder="Password" value="<?php echo $customSet['password']; ?>" required />
